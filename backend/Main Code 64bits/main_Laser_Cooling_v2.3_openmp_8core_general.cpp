...
void RePaint ()
{
    ...
    // N_Body_algorithmes Algorithme_N_body = (N_Body_algorithmes) data.IParam("Choix_algorithme_N_corps"); // Choix de l'alogithme N corps

    /***  NOM DES FICHIERS ***/
    string nom_sortie_temp_string, nom_sortie_scal_string, nom_file_Levels_string, nom_file_Lines_string,
           nom_sortie_donnees_string, nom_sortie_donnees_string1, nom_sortie_donnees_string2, nom_sortie_donnees_string3, nom_sortie_donnees_string4, nom_sortie_donnees_string5, nom_sortie_donnees_string6, nom_sortie_donnees_string7,
           nom_sortie_rate_string, nom_sortie_rate_string1, nom_sortie_rate_string2, nom_sortie_rate_string3, nom_sortie_rate_string4, nom_sortie_rate_string5, nom_sortie_rate_string6, nom_sortie_rate_string7,
    ...
    const char *nom_sortie_temp, *nom_sortie_scal, *nom_file_Levels, *nom_file_Lines,
          *nom_sortie_donnees, *nom_sortie_donnees1, *nom_sortie_donnees2, *nom_sortie_donnees3, *nom_sortie_donnees4, *nom_sortie_donnees5, *nom_sortie_donnees6, *nom_sortie_donnees7,
          *nom_sortie_rate, *nom_sortie_rate1, *nom_sortie_rate2, *nom_sortie_rate3, *nom_sortie_rate4, *nom_sortie_rate5, *nom_sortie_rate6, *nom_sortie_rate7,
	...
	nomdata.push_back("Data/Liste_Param4.h");
	nomdata.push_back("Data/Liste_Param5.h");
	nomdata.push_back("Data/Liste_Param6.h");
	nomdata.push_back("Data/Liste_Param7.h");
    ...
    sortrate_str.push_back("nom_sortie_rate4_string");
    sortrate_str.push_back("nom_sortie_rate5_string");
    sortrate_str.push_back("nom_sortie_rate6_string");
    sortrate_str.push_back("nom_sortie_rate7_string");
    ...
    sortrate.push_back("nom_sortie_rate4");
    sortrate.push_back("nom_sortie_rate5");
    sortrate.push_back("nom_sortie_rate6");
    sortrate.push_back("nom_sortie_rate7");
    ...
    sortrate_const.push_back(nom_sortie_rate4);
    sortrate_const.push_back(nom_sortie_rate5);
    sortrate_const.push_back(nom_sortie_rate6);
    sortrate_const.push_back(nom_sortie_rate7);
    ...
    sortdonn_str.push_back("nom_sortie_donnees4_string");
    sortdonn_str.push_back("nom_sortie_donnees5_string");
    sortdonn_str.push_back("nom_sortie_donnees6_string");
    sortdonn_str.push_back("nom_sortie_donnees7_string");
    ...
    sortdonn.push_back("nom_sortie_donnees4");
    sortdonn.push_back("nom_sortie_donnees5");
    sortdonn.push_back("nom_sortie_donnees6");
    sortdonn.push_back("nom_sortie_donnees7");
    ...
    sortdonn_const.push_back(nom_sortie_donnees4);
    sortdonn_const.push_back(nom_sortie_donnees5);
    sortdonn_const.push_back(nom_sortie_donnees6);
    sortdonn_const.push_back(nom_sortie_donnees7);

    #pragma omp parallel for num_threads(omp_get_max_threads()) private(RNG) //num_threads(omp_get_max_threads()) private(RNG) //schedule(static,10) //ordered
    for (RNG =0; RNG <8 ; RNG++)
    {
        ...
        sortdonn_str[RNG] = data.SParam(sortdonn[RNG]);
        sortrate_str[RNG] = data.SParam(sortrate[RNG]);
        ...
        sortdonn_const[RNG] = sortdonn_str[RNG].c_str();
        sortrate_const[RNG] = sortrate_str[RNG].c_str();
